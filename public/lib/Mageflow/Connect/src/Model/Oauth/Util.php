...
//    return array_map(array('OAuthUtil', 'urlencode_rfc3986'), $input);
     ...
     * @return array
     */
    public static function splitHeader(
        $header,
    ...
    )
    {
        ...
        if (preg_match_all(
            ...
            foreach ($matches[1] as $i => $h) {
                $params[$h] = self::urldecodeRFC3986(
    ...
    public static function parseParameters($input)
    {
        ...
        foreach ($pairs as $pair) {
            ...
            if (isset($parsed_parameters[$parameter])) {
                // We have already recieved parameter(s) with this name,
                // so add to the list of parameters with this name
    ...
    public static function buildHttpQuery($params)
    {
        ...
        // using lexicographical byte value ordering.
        // Ref: Spec: 9.1.1 (1)
        ...
        foreach ($params as $parameter => $value) {
            if (is_array($value)) {
                ...
                // Ref: Spec: 9.1.1 (1)
                // June 12th, 2010 - changed to sort
                // because of issue 164 by hidetaka
