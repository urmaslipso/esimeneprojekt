...
class Mageflow_Connect_Create_Backend_User extends Mage_Shell_Abstract
{
     ...
     */
    function createUser(
        $email = null, $firstname = null, $lastname = null, $verbose = false
    )
    {
        ...
        if (!$adminUser->getId()) {
            ...
            $adminRole->save();
            if ($verbose) {
                echo "Thank you! Your admin account has been created. ".
                    "We sent you e-mail with your admin account details\n";
            }
        }
